...
public class Future<T> {
	...
	/**
     * retrieves the result the Future object holds if it has been resolved. This is a blocking method. It waits for
	 * the computation in case it has not been completed.
     * <p>
